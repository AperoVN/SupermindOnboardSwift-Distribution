...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.33/OnboardFlowSDK-1.3.33.zip",
            checksum: "2b11e5ca9b7be2a860eebacbcf30055b74e5bfdb5289868f63df0d6f8c348ffa"
        ),
        .target(
