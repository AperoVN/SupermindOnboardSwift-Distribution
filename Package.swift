...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.4.7/OnboardFlowSDK-1.4.7.zip",
            checksum: "b5f61a183d1387737caa15934e8360a821ef6cc7e3f995e867a644b444b5e33f"
        ),
        .target(
