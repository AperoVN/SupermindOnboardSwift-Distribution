...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.11/OnboardFlowSDK-1.3.11.zip",
            checksum: "6b3414fdbea3ba4c0ea31623f915ebbfe020e5f658826c7cc0ad371d868dd8af"
        ),
        .target(
