...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.28/OnboardFlowSDK-1.3.28.zip",
            checksum: "c338f19c79f39610bd592857389c4773735fd9e3ff95d46dae6bff1c20a8e6a5"
        ),
        .target(
