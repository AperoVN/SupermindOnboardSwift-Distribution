...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.4.5/OnboardFlowSDK-1.4.5.zip",
            checksum: "42f9ec9031f9c8dce46b5a939783da0d60a5469f0173562e1f19de61fe924a51"
        ),
        .target(
