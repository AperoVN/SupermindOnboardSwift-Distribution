...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.35/OnboardFlowSDK-1.3.35.zip",
            checksum: "2493d4838d49459a7557ceda74e6e9db136193634ff57d07cab2c315d89ba02f"
        ),
        .target(
