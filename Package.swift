...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.19/OnboardFlowSDK-1.3.19.zip",
            checksum: "fa2d215636cd27ca702bea54fe9cee3171c5c526bed649f0d934f747535bdfac"
        ),
        .target(
