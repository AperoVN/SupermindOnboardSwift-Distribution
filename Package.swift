...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.10/OnboardFlowSDK-1.3.10.zip",
            checksum: "c997df5a607ce081a3a69ec0eb9c6795d0700a531d81c78a59a3fbc8fdb0eff9"
        ),
        .target(
