...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.13/OnboardFlowSDK-1.3.13.zip",
            checksum: "6ab370da7f3d9fd1427f9f681cfd309594084062a3e25b4a272d5b1e193cd07c"
        ),
        .target(
