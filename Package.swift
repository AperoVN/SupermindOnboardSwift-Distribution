...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.32/OnboardFlowSDK-1.3.32.zip",
            checksum: "9e8da24447df2f608d90e1d60d6a8065e56f74ce42cb72971d6b153a2aa52ce7"
        ),
        .target(
