...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.29/OnboardFlowSDK-1.3.29.zip",
            checksum: "52bcb26effb3894cdd054c6f2c8cfbfc94c05dd1cc11a510af237b4c176f111c"
        ),
        .target(
