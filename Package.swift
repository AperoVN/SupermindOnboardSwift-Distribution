...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.30/OnboardFlowSDK-1.3.30.zip",
            checksum: "92696f982219d542cb7a416b4d61ff9a41c4183e64b3cfd9c811c5fd3eac7ed6"
        ),
        .target(
