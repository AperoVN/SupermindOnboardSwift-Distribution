...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.8/OnboardFlowSDK-1.3.8.zip",
            checksum: "77f855d8627a2ec0c2569f79a7c8d4827b47e6cab9ebb7b6b4e5bc3f7b4db4d2"
        ),
        .target(
