...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.14/OnboardFlowSDK-1.3.14.zip",
            checksum: "20c466c231ed7cfec19ba4c65af01e74110bcbd266a94cefb465fbd1b8cd4ca9"
        ),
        .target(
