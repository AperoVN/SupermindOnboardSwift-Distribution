...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.5/OnboardFlowSDK-1.3.5.zip",
            checksum: "96a3e7c1ca5ff8f8754bbe0834e9b633928fd75decd4a33551eb172692487154"
        ),
        .target(
