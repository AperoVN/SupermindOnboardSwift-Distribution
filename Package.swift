...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.7/OnboardFlowSDK-1.3.7.zip",
            checksum: "b461fc5f360fa534b86b32f3e3e0c8e510932d88e33d436d9147e839c1344434"
        ),
        .target(
