...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.23/OnboardFlowSDK-1.3.23.zip",
            checksum: "4fcf10aa4ee3352673b12323d9e5c8488204bbe68a83982659bcec69cbd791dc"
        ),
        .target(
