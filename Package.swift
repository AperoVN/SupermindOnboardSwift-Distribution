...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.26/OnboardFlowSDK-1.3.26.zip",
            checksum: "04c027f30ac662340c803b54e06cf867acc75ddf56d2d403cec2500ae60c9c7a"
        ),
        .target(
