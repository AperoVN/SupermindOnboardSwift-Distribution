...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.9/OnboardFlowSDK-1.3.9.zip",
            checksum: "513df2489d43aca8357807fd17c2f4ece7c3ea9473479e5dc4cc6486af64cfaa"
        ),
        .target(
