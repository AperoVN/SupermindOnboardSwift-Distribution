...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.4.0/OnboardFlowSDK-1.4.0.zip",
            checksum: "84aa111e1f59bb8e50ff1c2b9ac317b6459141ecb39a76401cc547493033a98f"
        ),
        .target(
