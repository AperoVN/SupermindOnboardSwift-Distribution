...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.21/OnboardFlowSDK-1.3.21.zip",
            checksum: "b4ca62afcb5aeb7c78ce01a2a53e356ded0f6143638a0295c1407c8c88610765"
        ),
        .target(
