...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.4.3/OnboardFlowSDK-1.4.3.zip",
            checksum: "44295682d72cf094fbac8e2e45e391beb78e8da850bee7a6598f589c370927c9"
        ),
        .target(
