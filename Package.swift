...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.16/OnboardFlowSDK-1.3.16.zip",
            checksum: "95c55e0cccf6c3fe609a052f61935f48b52142a0cc0398cdda2f78bdcbd8b4e5"
        ),
        .target(
