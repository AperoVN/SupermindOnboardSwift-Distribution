...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AperoVN/SupermindOnboardSwift-Distribution/releases/download/1.3.24/OnboardFlowSDK-1.3.24.zip",
            checksum: "a99c452f9f1a52d390fa89a7dba32c96b6cf16786e5d69bb0484468d4e597165"
        ),
        .target(
